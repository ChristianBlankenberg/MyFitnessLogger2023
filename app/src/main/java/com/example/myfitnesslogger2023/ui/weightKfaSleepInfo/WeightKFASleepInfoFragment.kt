...
class WeightKFAFragment : SendInfoBaseFragment() {
    ...
    override fun reInitializeLabels() {
        GlobalScope.launch {
            ...
            val todaysSleepDurationHours =
                weightAndKFAViewModel.getTodaysSleepDurationHours(activity)
            val todaysSleepDurationMinutes =
                weightAndKFAViewModel.getTodaysSleepDurationMinutes(activity)
